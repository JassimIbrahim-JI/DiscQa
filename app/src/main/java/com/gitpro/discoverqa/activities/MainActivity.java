...
import com.gitpro.discoverqa.fragments.HelpFeedbackFragment;
import com.gitpro.discoverqa.adapters.InterestsAdapter;
import com.gitpro.discoverqa.fragments.ProfileFragment;
import com.gitpro.discoverqa.R;
import com.gitpro.discoverqa.fragments.TourFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
 ...
 private FirebaseAuth.AuthStateListener mFirebaseAuthListener;
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        String HELP_FEEDBACK_FRAGMENT_TAG = "help_feedback";
    ...
    public void changeToolbarTitle(String str) {
        TextView mTextView = mToolbar.findViewById(R.id.toolbar_title);
