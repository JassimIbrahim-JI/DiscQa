...
import com.gitpro.discoverqa.CustomTextView;
...
public class InterestsAdapter extends RecyclerView.Adapter<InterestsAdapter.ImageViewHolder> {
    ...
    String[] interests;
    String[] interests_ar;
    public static List<String> interests_chosen;
    public static HashSet<String> intrests_hashSet;
    int counter[];
    ...
    public ImageViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.interests_cat,
                viewGroup, false);
